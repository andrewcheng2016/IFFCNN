...
def TimeComparisonPlot(opt, time, method, timeType, remove_path=False):
    ...
    classifier = "Simplified Classifier" if (opt.simplified_classifier == True) else "Original Classifier"

    if(opt.retrain == True):
        save_path = './Comparison/Time/{}/Retrain/BatchSize_{}/'.format(classifier, opt.num_samples_per_batch)
    else:
        save_path = './Comparison/Time/{}/Non Retrain/BatchSize_{}/'.format(classifier, opt.num_samples_per_batch)
...
def AccuracyComparisonPlot(opt, acc, method, remove_path=False):
    ...
    if(opt.retrain == True):
        save_path = './Comparison/Accuracy/{}/Retrain/BatchSize_{}/'.format(classifier, opt.num_samples_per_batch)
    else:
        save_path = './Comparison/Accuracy/{}/Non Retrain/BatchSize_{}/'.format(classifier, opt.num_samples_per_batch)
